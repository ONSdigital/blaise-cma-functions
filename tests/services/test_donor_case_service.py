...
class TestCheckAndCreateDonorCaseForUsers:
    ...
    def test_check_and_create_donor_case_for_ips_manager_never_has_negative_expected_count(
        self,
        mock_assert_expected_number_of_donor_cases_created,
        mock_create_donor_case_for_user,
        mock_get_all_existing_donor_cases,
        ...
        questionnaire_name = "IPS2502A"
        guid = "8eb31187-4295-46fc-a939-97a2fc24bc0e"
        users_with_role = ["ips3"]
    ...
    def test_check_and_create_donor_case_for_ips_field_interviewer_creates_only_missing_users(
        self,
        mock_assert_expected_number_of_donor_cases_created,
        mock_create_donor_case_for_user,
        mock_get_all_existing_donor_cases,
        ...
        # assert
        assert mock_create_donor_case_for_user.call_count == 2
        mock_assert_expected_number_of_donor_cases_created.assert_called_with(
            expected_number_of_cases_to_create=2, total_donor_cases_created=2
        )
    ...
    def test_check_and_create_donor_case_for_ips_field_interviewer_rerun_does_not_create_duplicates(
        self,
        mock_assert_expected_number_of_donor_cases_created,
        mock_create_donor_case_for_user,
        mock_get_all_existing_donor_cases,
    ...
    def test_check_and_create_donor_case_for_ips_manager_creates_only_new_case_when_mixed_existing_state(
        self,
        mock_assert_expected_number_of_donor_cases_created,
        mock_create_donor_case_for_user,
        mock_get_all_existing_donor_cases,
